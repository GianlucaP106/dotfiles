...
alias wbst = webstorm
alias q = exit
# alias privip = ifconfig | grep 'inet ' | grep -v 127.0.0.1 | awk '{print $2}'
...
# alias auth-req = echo curl -X POST -H \"Authorization: Bearer YOUR_TOKEN_HERE\" -H \"Content-Type: application/json\" -d \''{"key1\":"value1\", \"key2\":\"value2\"}'\'' YOUR_API_ENDPOINT_URL'

# OS
alias l = ls -alh
# alias viewpath = echo $env.PATH | tr ':' '\n' | xargs -I{} find {} -type f -perm +111 2>/dev/null
alias cl = clear
